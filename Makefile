...
OBJS_FILE_NAMES = jc_util.o sub_stream.o math_parser.o iof_num.o
...
math_parser: $(SRC_DIR)/math_parser_driver.c math_parser.o
	$(CC) $(CFLAGS) $(SRC_DIR)/math_parser_driver.c $(BUILD_DIR)/math_parser.o $(BUILD_DIR)/iof_num.o $(BUILD_DIR)/jc_util.o $(LFLAGS) -o math_parser
...
math_parser_tests: $(TESTS_DIR)/math_parser_tests.c jc_util.o iof_num.o math_parser.o
	$(CC) $(CFLAGS) -c $(TESTS_DIR)/$@.c  -o $(BUILD_DIR)/$@.o
	$(CC) $(CFLAGS) $(BUILD_DIR)/math_parser.o $(BUILD_DIR)/jc_util.o $(BUILD_DIR)/iof_num.o $(BUILD_DIR)/$@.o $(LFLAGS) -o $(BUILD_DIR)/$@ -lm
	$(BUILD_DIR)/$@
